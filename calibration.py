...
#nomDuFichier = '/home/pi/Documents/Projet_Chloe/Fichiers mesures/datacalib.csv'
...
print("Calibration: X_offset={0:4.1f} deg, Y_offset={1:4.1f} deg, gyro_X_offset={2:4.1f}, gyro_Y_offset={3:4.1f}".format(rotation_offset_x, rotation_offset_y,gyro_offset_x, gyro_offset_y))
